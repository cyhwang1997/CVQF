...
plot "21insertvqf" using 1:2 ls 1 title "Vector Quotient Filter", \
       "21insertcvqf" using 1:2 ls 2 title "Counting Vector Quotient Filter", \
       "21insertcuckoo" using 1:2 ls 3 title "Cuckoo Filter", \
       "21insertmorton" using 1:2 ls 4 title "Morton Filter", \
       "21insertqf" using 1:2 ls 5 title "Quotient Filter"
