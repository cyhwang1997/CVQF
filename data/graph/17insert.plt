...
plot "17insertvqf" using 1:2 ls 1 title "Vector Quotient Filter", \
       "17insertcvqf" using 1:2 ls 2 title "Counting Vector Quotient Filter", \
       "17insertcuckoo" using 1:2 ls 3 title "Cuckoo Filter", \
       "17insertmorton" using 1:2 ls 4 title "Morton Filter", \
       "17insertqf" using 1:2 ls 5 title "Quotient Filter"
