...
plot "17negativevqf" using 1:2 ls 1 title "Vector Quotient Filter", \
       "17negativecvqf" using 1:2 ls 2 title "Counting Vector Quotient Filter", \
       "17negativecuckoo" using 1:2 ls 3 title "Cuckoo Filter", \
       "17negativemorton" using 1:2 ls 4 title "Morton Filter", \
       "17negativeqf" using 1:2 ls 5 title "Quotient Filter"
