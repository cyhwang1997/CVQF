...
plot "21removevqf" using 1:2 ls 1 title "Vector Quotient Filter", \
       "21removecvqf" using 1:2 ls 2 title "Counting Vector Quotient Filter", \
       "21removecuckoo" using 1:2 ls 3 title "Cuckoo Filter", \
       "21removemorton" using 1:2 ls 4 title "Morton Filter", \
       "21removeqf" using 1:2 ls 5 title "Quotient Filter"
