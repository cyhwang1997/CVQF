...
plot "17positivevqf" using 1:2 ls 1 title "Vector Quotient Filter", \
       "17positivecvqf" using 1:2 ls 2 title "Counting Vector Quotient Filter", \
       "17positivecuckoo" using 1:2 ls 3 title "Cuckoo Filter", \
       "17positivemorton" using 1:2 ls 4 title "Morton Filter", \
       "17positiveqf" using 1:2 ls 5 title "Quotient Filter"
