...
plot "21positivevqf" using 1:2 ls 1 title "Vector Quotient Filter", \
       "21positivecvqf" using 1:2 ls 2 title "Counting Vector Quotient Filter", \
       "21positivecuckoo" using 1:2 ls 3 title "Cuckoo Filter", \
       "21positivemorton" using 1:2 ls 4 title "Morton Filter", \
       "21positiveqf" using 1:2 ls 5 title "Quotient Filter"
