...
plot "21negativevqf" using 1:2 ls 1 title "VQF", \
       "21negativecvqf" using 1:2 ls 2 title "CVQF", \
       "21negativecuckoo" using 1:2 ls 3 title "CF", \
       "21negativemorton" using 1:2 ls 4 title "MF", \
       "21negativeqf" using 1:2 ls 5 title "QF"
