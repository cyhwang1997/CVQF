...
plot "17insertvqf" using 1:2 ls 1 title "VQF", \
       "17insertcvqf" using 1:2 ls 2 title "CVQF", \
       "17insertcuckoo" using 1:2 ls 3 title "CF", \
       "17insertmorton" using 1:2 ls 4 title "MF", \
       "17insertqf" using 1:2 ls 5 title "QF"
